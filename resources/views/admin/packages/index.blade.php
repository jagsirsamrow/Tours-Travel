    ...
    <div class="page-body">
        ...
        <div class="title-header">
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.packages.create') }}" class="btn btn-block btn-light">Add Package</a>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <form action="{{ route('admin.packages.destroy',$item->id) }}" method="POST" id="delete_form_{{$item->id}}">
                                                                @csrf
                                                                @method('DELETE')
