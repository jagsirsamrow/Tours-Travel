...
@section('content')
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
            <form class="theme-form theme-form-2 mega-form" role="form" action="{{ route('admin.sliders.store') }}"
                ...
                <div class="row">
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="s_heading" tabindex="4" type="text">
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="s_content" type="text">
                        </div>
                    </div>
