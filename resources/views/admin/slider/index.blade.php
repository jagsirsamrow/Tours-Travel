    ...
    <div class="page-body">
        ...
        <div class="title-header">
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.sliders.create') }}" class="btn btn-block btn-light">Add Slider</a>
                </div>
            </div>
                                    ...
                                    <table class="table table-striped all-package">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->s_heading }}</td>

                                                <td>{{ $item->s_content }}</td>
                                                ...
                                                <td>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <form action="{{ route('admin.sliders.destroy',$item->id) }}" method="POST" id="delete_form_{{$item->id}}">
                                                                @csrf
                                                                @method('DELETE')
