...
@section('content')
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
            <form class="theme-form theme-form-2 mega-form" role="form" action="{{ route('admin.cars.update',$data->id) }}"
                ...
                <div class="row">
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="model" tabindex="4" type="text" value="{{$data->model}}">
                            @if ($errors->has('model'))
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="type" tabindex="4" type="number" value="{{$data->type}}">
                            @if ($errors->has('type'))
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="passengers" type="number" value="{{$data->passenger}}">
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="bags" type="number" value="{{$data->bags}}">
                            @if ($errors->has('bags'))
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="extra" type="number"  value="{{$data->extra_fare}}">
                            @if ($errors->has('extra'))
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="per_kilo_m" type="number" value="{{$data->per_kilo_m}}">
