...
@section('content')
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
            <form class="theme-form theme-form-2 mega-form" role="form" action="{{ route('admin.city.update',$data->id) }}"
                ...
                <div class="row">
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="district" tabindex="4" type="text"value="{{$data->district}}">
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-md-9 col-lg-10">
                            <input class="form-control" name="publish" tabindex="4" type="number"value="{{$data->publish}}">
