    ...
    <div class="page-body">
        ...
        <div class="title-header">
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.city.create') }}" class="btn btn-block btn-light">Add Team mamber</a>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <form action="{{ route('admin.city.destroy',$item->id) }}" method="POST" id="delete_form_{{$item->id}}">
                                                                @csrf
                                                                @method('DELETE')
